...
import { Menu, ClipboardList, ShoppingBag, User } from 'lucide-react';
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-[100] flex justify-between items-center transition-all duration-500 ${
      ...
      <div className="flex items-center gap-8">
        ...
        {/* AUTH SECTION REMOVED (SAFE STATIC UI) */}
        ...
        <Link to="/checkout" className="relative hover:text-orange-500 transition-colors">
          <ShoppingBag size={20} />
          {cartCount > 0 && (
